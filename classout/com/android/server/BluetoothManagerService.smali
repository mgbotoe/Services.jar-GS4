...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/BluetoothManagerService$BufferLog;,
...
.field public static mBufferLog:Lcom/android/server/BluetoothManagerService$BufferLog;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    :cond_af
    new-instance v1, Lcom/android/server/BluetoothManagerService$BufferLog;

    invoke-direct {v1, p0}, Lcom/android/server/BluetoothManagerService$BufferLog;-><init>(Lcom/android/server/BluetoothManagerService;)V

    sput-object v1, Lcom/android/server/BluetoothManagerService;->mBufferLog:Lcom/android/server/BluetoothManagerService$BufferLog;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v2, "inside dump, size1: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-object v2, Lcom/android/server/BluetoothManagerService;->mBufferLog:Lcom/android/server/BluetoothManagerService$BufferLog;

    #getter for: Lcom/android/server/BluetoothManagerService$BufferLog;->mainBuffer:Ljava/lang/String;
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService$BufferLog;->access$3900(Lcom/android/server/BluetoothManagerService$BufferLog;)Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/BluetoothManagerService$BufferLog;->subBuffer:Ljava/lang/StringBuilder;
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService$BufferLog;->access$4000(Lcom/android/server/BluetoothManagerService$BufferLog;)Ljava/lang/StringBuilder;
    ...
    sget-object v0, Lcom/android/server/BluetoothManagerService;->mBufferLog:Lcom/android/server/BluetoothManagerService$BufferLog;

    #getter for: Lcom/android/server/BluetoothManagerService$BufferLog;->mainBuffer:Ljava/lang/String;
    invoke-static {v0}, Lcom/android/server/BluetoothManagerService$BufferLog;->access$3900(Lcom/android/server/BluetoothManagerService$BufferLog;)Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/BluetoothManagerService$BufferLog;->subBuffer:Ljava/lang/StringBuilder;
    invoke-static {v0}, Lcom/android/server/BluetoothManagerService$BufferLog;->access$4000(Lcom/android/server/BluetoothManagerService$BufferLog;)Ljava/lang/StringBuilder;
...
.method public putLogs(Ljava/lang/String;)V
    ...
    :try_start_1b
    sget-object v1, Lcom/android/server/BluetoothManagerService;->mBufferLog:Lcom/android/server/BluetoothManagerService$BufferLog;

    invoke-virtual {v1, p1}, Lcom/android/server/BluetoothManagerService$BufferLog;->putLogs(Ljava/lang/String;)V
    :try_end_20
    .catchall {:try_start_1b .. :try_end_20} :catchall_22
    .catch Ljava/lang/Exception; {:try_start_1b .. :try_end_20} :catch_25
    ...
    const-string v3, "mBufferLog.putLogs"
